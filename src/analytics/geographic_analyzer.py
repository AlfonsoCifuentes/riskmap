...
class GeographicAnalyzer:
    def __init__(self, config):
        ...
        self.risk_keywords = {
            'high': ['war', 'conflict', 'attack', 'bombing', 'terrorism', 'crisis', 'sanctions', 'invasion'],
            'medium': ['protest', 'tension', 'dispute', 'negotiation', 'diplomatic', 'trade war'],
            'low': ['cooperation', 'agreement', 'partnership', 'summit', 'visit', 'economic growth']
        }

    def analyze_article_geography(self, article_content: str, article_title: str) -> Dict[str, Any]:
        """
    ...
    def write_heatmap_csv(self, region_stats: Dict) -> None:
        ...
        for region, stats in region_stats.items():
            avg_risk_score = stats['total_risk_score'] / stats['articles_count'] if stats['articles_count'] > 0 else 0
            ...
            heatmap_data.append({
                ...
                'risk_intensity': min(stats['articles_count'] * avg_risk_score, 100),  # Cap at 100
