...
class IntelligenceSourcesRegistry:
                ...
                'us': [
                    {
                        ...
                        'country': 'US',
                        'credibility': 'high',
                        'focus': ['diplomacy', 'international_relations', 'security']
                    },
                    {
                        ...
                        'country': 'US',
                        'credibility': 'high',
                        'focus': ['policy', 'governance', 'economics']
                    },
                    {
                        ...
                        'country': 'US',
                        'credibility': 'high',
                        'focus': ['democracy', 'nuclear_policy', 'regional_studies']
                    },
                    {
                        ...
                        'country': 'US',
                        'credibility': 'high',
                        'focus': ['defense', 'security', 'technology']
                    },
                    {
                        ...
                        'country': 'US',
                        'credibility': 'high',
                        'focus': ['nato', 'transatlantic', 'emerging_threats']
                    },
                    {
                        ...
                        'country': 'US',
                        'credibility': 'medium',
                        'focus': ['defense', 'foreign_policy', 'economics']
                    },
                    {
                        ...
                        'country': 'US',
                        'credibility': 'medium',
                        'focus': ['climate', 'democracy', 'immigration']
                    }
                ],
                'uk': [
                    {
                        ...
                        'country': 'GB',
                        'credibility': 'high',
                        'focus': ['global_governance', 'conflict', 'sustainability']
                    },
                    {
                        ...
                        'country': 'GB',
                        'credibility': 'high',
                        'focus': ['defense', 'security', 'geopolitics']
                    },
                    {
                        ...
                        'country': 'GB',
                        'credibility': 'high',
                        'focus': ['political_risk', 'economics', 'forecasting']
                    }
                ],
                'europe': [
                    {
                        ...
                        'country': 'EU',
                        'credibility': 'high',
                        'focus': ['eu_policy', 'european_security', 'multilateralism']
                    },
                    {
                        ...
                        'country': 'DE',
                        'credibility': 'high',
                        'focus': ['transatlantic_relations', 'democracy', 'security']
                    },
                    {
                        ...
                        'country': 'FR',
                        'credibility': 'high',
                        'focus': ['european_integration', 'africa', 'middle_east']
                    },
                    {
                        ...
                        'country': 'SE',
                        'credibility': 'high',
                        'focus': ['arms_control', 'conflict', 'security']
                    }
                ],
                'asia': [
                    {
                        ...
                        'country': 'US',
                        'credibility': 'high',
                        'focus': ['asia_pacific', 'regional_cooperation', 'development']
                    },
                    {
                        ...
                        'country': 'IN',
                        'credibility': 'medium',
                        'focus': ['south_asia', 'strategic_studies', 'economics']
                    },
                    {
                        'name': 'Lowy Institute',
                        ...
                        'country': 'AU',
                        'credibility': 'high',
                        'focus': ['indo_pacific', 'australia_relations', 'regional_security']
                    }
                ]
            },
            ...
            'academic_institutions': [
                {
                    ...
                    'country': 'US',
                    'credibility': 'high',
                    'focus': ['science_policy', 'international_security', 'diplomacy']
                },
                {
                    ...
                    'country': 'US',
                    'credibility': 'high',
                    'focus': ['international_studies', 'democracy', 'development']
                },
                {
                    ...
                    'country': 'GB',
                    'credibility': 'high',
                    'focus': ['international_affairs', 'diplomacy', 'strategy']
                }
            ],
            ...
            'government_sources': [
                {
                    ...
                    'country': 'US',
                    'credibility': 'high',
                    'focus': ['diplomatic_statements', 'policy_announcements']
                },
                {
                    ...
                    'country': 'EU',
                    'credibility': 'high',
                    'focus': ['eu_foreign_policy', 'diplomatic_relations']
                },
                {
                    ...
                    'country': 'GB',
                    'credibility': 'high',
                    'focus': ['uk_foreign_policy', 'diplomatic_announcements']
                }
            ],
            ...
            'specialized_media': [
                {
                    ...
                    'country': 'US',
                    'credibility': 'high',
                    'focus': ['international_affairs', 'geopolitics', 'analysis']
                },
                {
                    ...
                    'country': 'US',
                    'credibility': 'high',
                    'focus': ['international_relations', 'policy_analysis']
                },
                {
                    ...
                    'country': 'US',
                    'credibility': 'medium',
                    'focus': ['global_affairs', 'regional_analysis']
                },
                {
                    'name': 'The Diplomat',
                    ...
                    'country': 'US',
                    'credibility': 'medium',
                    'focus': ['asia_pacific', 'regional_politics', 'security']
                },
                {
                    'name': 'Al-Monitor',
                    ...
                    'country': 'US',
                    'credibility': 'medium',
                    'focus': ['middle_east', 'regional_politics', 'security']
                }
            ],
            ...
            'intelligence_analysis': [
                {
                    ...
                    'country': 'US',
                    'credibility': 'medium',
                    'focus': ['geopolitical_forecasting', 'security_analysis']
                },
                {
                    ...
                    'country': 'GB',
                    'credibility': 'high',
                    'focus': ['defense', 'security', 'military_analysis']
                },
                {
                    ...
                    'country': 'FR',
                    'credibility': 'medium',
                    'focus': ['intelligence_services', 'corporate_intelligence']
                }
            ],
            ...
            'economic_intelligence': [
                {
                    ...
                    'country': 'US',
                    'credibility': 'high',
                    'focus': ['international_economics', 'trade', 'monetary_policy']
                },
                {
                    ...
                    'country': 'CH',
                    'credibility': 'medium',
                    'focus': ['global_economy', 'public_private_cooperation']
                },
                {
                    ...
                    'country': 'US',
                    'credibility': 'high',
                    'focus': ['monetary_policy', 'financial_stability', 'development']
                }
            ]
        }
    ...
    def get_sources_by_focus(self, focus_area: str) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            if any(focus_area.lower() in focus.lower() for focus in s.get('focus', []))
        ]
...
class IntelligenceCollector:
    ...
    def __init__(self):
        ...
        self.db = DatabaseManager(config)  # Fixed: use config directly, not config.config
        self.request_timeout = 30
        self.request_delay = 1.0
        
    async def collect_intelligence_sources_async(self, 
                                               categories: List[str] = None,
                                               max_articles_per_source: int = 10) -> List[Dict[str, Any]]:
        """Collect from intelligence sources asynchronously."""
        if categories is None:
            categories = ['think_tanks', 'specialized_media', 'intelligence_analysis']
        
        all_sources = []
        for category in categories:
            all_sources.extend(self.sources_registry.get_sources_by_category(category))
        
        # Filter to high credibility sources for quality
        high_credibility_sources = [s for s in all_sources if s.get('credibility') == 'high']
        ...
        async with aiohttp.ClientSession(timeout=aiohttp.ClientTimeout(total=self.request_timeout)) as session:
            ...
            for source in high_credibility_sources:
                if 'rss' in source:
                    task = self._fetch_intelligence_rss_async(session, source, max_articles_per_source)
                    tasks.append(task)
        ...
        logger.info(f"Collected {len(all_articles)} intelligence articles from {len(high_credibility_sources)} sources")
        return all_articles
    
    async def _fetch_intelligence_rss_async(self, session: aiohttp.ClientSession,
                                          source: Dict[str, Any], max_articles: int) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.debug(f"Collected {len(articles)} intelligence articles from {source['name']}")
            return articles
            
        except Exception as e:
            logger.error(f"Error fetching intelligence RSS from {source['name']}: {e}")
            return []
    
    def _process_intelligence_entry(self, entry: Any, source: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _assess_intelligence_value(self, entry: Any, source: Dict[str, Any]) -> str:
        ...
        # Assess value
        credibility_score = {'high': 3, 'medium': 2, 'low': 1}.get(source.get('credibility', 'low'), 1)
    ...
    def _save_intelligence_articles(self, articles: List[Dict[str, Any]]) -> int:
        ...
        try:
            ...
            logger.error(f"Error saving intelligence articles to database: {e}")
            return 0
    ...
    def get_intelligence_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'total_sources': len(self.sources_registry.get_all_sources()),
                'high_credibility_sources': len(self.sources_registry.get_high_credibility_sources())
            }
