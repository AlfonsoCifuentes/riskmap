...
class UnifiedWebApplication:
    ...
    def _integrate_dash_apps(self):
        ...
        try:
            # Historical Dashboard - No modificar requests_pathname_prefix después de init
            historical_dash = self.dash_apps['historical'].app
            # historical_dash.config.requests_pathname_prefix = '/dash/historical/'  # Comentado - causa error
            historical_dash.server = self.flask_app
            
            # Multivariate Dashboard - No modificar requests_pathname_prefix después de init
            multivariate_dash = self.dash_apps['multivariate'].app
            # multivariate_dash.config.requests_pathname_prefix = '/dash/multivariate/'  # Comentado - causa error
