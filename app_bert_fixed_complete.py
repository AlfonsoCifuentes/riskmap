...
# =====================================================
# GROQ AI ANALYSIS ENDPOINTS ADICIONALES
# =====================================================
...
@app.route('/api/generate-ai-analysis-v2', methods=['POST'])
def generate_groq_ai_analysis_v2():
    """
    Endpoint alternativo para generar análisis geopolítico con Groq IA
    """
    try:
        ...
        logger.info(f"✅ Análisis geopolítico V2 generado: {len(articles)} artículos procesados")
        return jsonify(response)
        
    except Exception as e:
        logger.error(f"❌ Error en endpoint de análisis V2: {e}")
        return jsonify({
...
if __name__ == '__main__':
    ...
    print("🌍 Groq Analysis V2: http://localhost:5003/api/generate-ai-analysis-v2")
