...
(function () {
  ...
  var T = {
    ...
    es: {
      ...
      'index.subtitle': 'Monitoreo global de conflictos en tiempo real',
      'index.desc': 'Pipeline automatizado de ingesta multi-fuente, filtrado de conflictos geopolíticos y desastres naturales, curación editorial, análisis con IA y visualización geoespacial.',
      ...
      'index.noMoreArticles': 'No hay más noticias',
      ...
      'index.loadError': 'No se pudieron cargar las noticias',
      'index.loadErrorDesc': 'La fuente de datos no responde ahora mismo. Reintenta en unos segundos.',
    ...
    en: {
      ...
      'index.subtitle': 'Real time global conflict monitoring',
      'index.desc': 'Automated multi-source ingestion pipeline, geopolitical conflict and natural disaster filtering, editorial curation, AI analysis, and geospatial visualization.',
      ...
      'index.noMoreArticles': 'No more articles',
      ...
      'index.loadError': 'Could not load the news',
      'index.loadErrorDesc': 'The data source is not responding right now. Retry in a few seconds.',
