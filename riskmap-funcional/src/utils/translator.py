...
class MultilingualTranslator:
    ...
    def get_cache_key(self, text: str, target_lang: str,
    ...
    def translate_dict(self, data: Dict[str, Any], target_lang: str,
        ...
        for key in translate_keys:
            if key in translated_data and isinstance(
                    translated_data[key], str):
                translated_data[key] = self.translate(
                    translated_data[key], target_lang)
